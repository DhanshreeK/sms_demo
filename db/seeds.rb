...
Vishwa Education
7030306611')
user = User.create!(:email => 'jawaan@gmail.com', :password => '123456789', :password_confirmation => '123456789', general_setting_id: gs.id, role: 'SuperAdmin',sms_setting_id: sms.id, email_setting_id: email.id)
